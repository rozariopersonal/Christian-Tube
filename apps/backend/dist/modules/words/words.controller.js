...
let WordsController = class WordsController {
    ...
    async getWords(category, translation, search, page, limit, seed) {
...
__decorate([
    (0, common_1.Get)('offline-db'),
    __param(0, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], WordsController.prototype, "downloadOfflineDb", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('category')),
    __param(1, (0, common_1.Query)('translation')),
    __param(2, (0, common_1.Query)('search')),
    __param(3, (0, common_1.Query)('page')),
    __param(4, (0, common_1.Query)('limit')),
    __param(5, (0, common_1.Query)('seed')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], WordsController.prototype, "seedWords", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], WordsController.prototype, "createWord", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WordsController.prototype, "likeWord", null);
exports.WordsController = WordsController = __decorate([
    (0, common_1.Controller)(['words', 'api/words', 'micro-feed', 'api/micro-feed', 'micro-feeds', 'api/micro-feeds']),
