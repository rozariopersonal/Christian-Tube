...
/// One selectable language row inside a language picker: badge, names, native
/// script, item count, and a multi-select checkbox.
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  '$itemCount ${countNoun(itemNoun, itemCount)}',
                  style: TextStyle(
                    color: isSelected
                        ? tokens.accent
