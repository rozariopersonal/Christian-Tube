...
class _AdminUsersScreenState extends State<AdminUsersScreen> {
    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, _) {
          ...
          final blockedCount =
              users.where((u) => u['isBlocked'] == true).length;
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildStatCard('Active', '$activeCount',
                              Theme.of(context).colorScheme.tertiary),
                          _buildStatCard('Blocked', '$blockedCount',
                ...
                Expanded(
                  child: widget.userService.isLoadingUsers && users.isEmpty
                      ...
                      : users.isEmpty
                          ...
                          : RefreshIndicator(
                              onRefresh: () async => widget.userService
                                  .fetchRegisteredUsers(_searchController.text),
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final lastLogin = user['lastLoginAt'] != null
                                      ? DateFormat.yMMMd().format(
                                          DateTime.tryParse(user['lastLoginAt']
                                                  .toString()) ??
                                              DateTime.now())
                                      : 'Recently';
                                      ...
                                      children: [
                                        ...
                                        if (role != 'ADMIN')
                                          ElevatedButton(
                                            ...
                                            onPressed: () =>
                                                _confirmToggleBlock(context, id,
                                                    name, isBlocked),
                                            child: Text(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(label,
              style: TextStyle(
                  fontSize: 13, color: context.tokens.onSurfaceMuted)),
        ],
      ),
    );
  }
  ...
  void _confirmToggleBlock(
      BuildContext context, String userId, String name, bool currentlyBlocked) {
    showDialog(
      context: context,
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: currentlyBlocked
                  ? Theme.of(context).colorScheme.tertiary
                  : Theme.of(context).colorScheme.error,
              foregroundColor: currentlyBlocked
