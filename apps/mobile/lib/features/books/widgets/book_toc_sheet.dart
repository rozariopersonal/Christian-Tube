...
///
/// On `compact` screens this renders as a draggable bottom sheet; on
/// `medium`/`expanded` it renders as a centered dialog (per AGENTS.md
/// Responsive & Adaptive UI Standard rule 6).
class BookTocSheet extends StatefulWidget {
  ...
  /// Optional scroll controller (provided by a wrapping DraggableScrollableSheet
  /// on compact screens); null on the dialog variant.
    ...
    if (screen.isCompact) {
      return showModalBottomSheet<void>(
        ...
        builder: (_) => DraggableScrollableSheet(
          ...
          maxChildSize: 0.92,
          expand: false,
          builder: (context, scrollController) => MaxWidthBox(
            maxWidth: 640,
            child: BookTocSheet(
              bookTitle: bookTitle,
              chapters: chapters,
