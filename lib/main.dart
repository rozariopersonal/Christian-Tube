...
void main() async {
  ...
  runApp(const ChristianTubeApp());
}

class ChristianTubeApp extends StatefulWidget {
  const ChristianTubeApp({super.key});

  @override
  State<ChristianTubeApp> createState() => _ChristianTubeAppState();
}

class _ChristianTubeAppState extends State<ChristianTubeApp> {
